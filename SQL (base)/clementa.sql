...
--
-- Table structure for table `Objets_des_dresseurs`
--
...
--
-- Table structure for table `Pokemon_des_dresseurs`
--
...
--
-- Table structure for table `Stat_basique_pokemon`
--
...
--
-- Dumping data for table `Stat_basique_pokemon`
--
...
--
-- Indexes for table `Objets_des_dresseurs`
--
...
--
-- Indexes for table `Pokemon_des_dresseurs`
--
...
--
-- Indexes for table `Stat_basique_pokemon`
--
...
--
-- AUTO_INCREMENT for table `Pokemon_des_dresseurs`
--
ALTER TABLE `Pokemon_des_dresseurs`
  MODIFY `Id_pokemon` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `Stat_basique_pokemon`
--
ALTER TABLE `Stat_basique_pokemon`
  MODIFY `Num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;
...
--
-- Constraints for table `Objets_des_dresseurs`
--
ALTER TABLE `Objets_des_dresseurs`
...
--
-- Constraints for table `Pokemon_des_dresseurs`
--
ALTER TABLE `Pokemon_des_dresseurs`
...
--
-- Constraints for table `Stat_basique_pokemon`
--
ALTER TABLE `Stat_basique_pokemon`
